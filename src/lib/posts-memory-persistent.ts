...
// Use a global variable that persists across requests in the same serverless function instance
declare global {
  var __persistentPosts: Post[] | undefined;
}

// Initialize with default posts if not set
if (!globalThis.__persistentPosts) {
  globalThis.__persistentPosts = [...defaultPosts];
}

// Get all posts
export function getAllPosts(): Post[] {
  return [...(globalThis.__persistentPosts || defaultPosts)];
}
