            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-transparent text-white placeholder-gray-400 backdrop-blur-sm"
              ...
              <button
                type="submit"
                className="w-full pill-button pill-primary"
              >
                Send Message
              </button>
            </form>
