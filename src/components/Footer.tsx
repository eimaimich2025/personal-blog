    ...
    <footer className="glass-dark border-t border-white/10 mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <div className="mb-8">
            <h3 className="text-2xl font-bold gradient-text mb-2">Digital Universe</h3>
            <p className="text-gray-400">Exploring the infinite possibilities of technology and creativity</p>
          </div>
          ...
          <div className="border-t border-white/10 pt-8">
            <p className="text-gray-500">
              © {new Date().getFullYear()} Digital Universe. Crafted with passion in the digital cosmos.
            </p>
          </div>
        </div>
      </div>
